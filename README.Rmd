...
[![ada-url Version](https://img.shields.io/badge/ada_url-4.0.0-blue)](https://github.com/ada-url/ada)
<!-- badges: end -->
...
- public suffix extraction (including privately registered suffixes such as `github.io`) like [psl](https://github.com/hrbrmstr/psl)
...
`public_suffix()` extracts their top level domain from the [public suffix list](https://publicsuffix.org/). Privately registered suffixes such as `github.io` and `blogspot.com` are **included** by default; pass `icann_only = TRUE` to use only the ICANN section.
