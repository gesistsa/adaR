...
ada_has_credentials <- function(url) {
    ...
    Rcpp_ada_has_credentials(url, nchar(url, type = "bytes"))
}
...
ada_has_empty_hostname <- function(url) {
    url <- stringi::stri_enc_toutf8(url)
    Rcpp_ada_has_empty_hostname(url, nchar(url, type = "bytes"))
}
...
ada_has_hostname <- function(url) {
    url <- stringi::stri_enc_toutf8(url)
    Rcpp_ada_has_hostname(url, nchar(url, type = "bytes"))
}
...
ada_has_non_empty_username <- function(url) {
    url <- stringi::stri_enc_toutf8(url)
    Rcpp_ada_has_non_empty_username(url, nchar(url, type = "bytes"))
}
...
ada_has_non_empty_password <- function(url) {
    url <- stringi::stri_enc_toutf8(url)
    Rcpp_ada_has_non_empty_password(url, nchar(url, type = "bytes"))
}
...
ada_has_port <- function(url) {
    url <- stringi::stri_enc_toutf8(url)
    Rcpp_ada_has_port(url, nchar(url, type = "bytes"))
}
...
ada_has_hash <- function(url) {
    url <- stringi::stri_enc_toutf8(url)
    Rcpp_ada_has_hash(url, nchar(url, type = "bytes"))
}
...
ada_has_search <- function(url) {
    url <- stringi::stri_enc_toutf8(url)
    Rcpp_ada_has_search(url, nchar(url, type = "bytes"))
}
