...
By default we include "private" suffixes (e.g., blogspot.com) that allow people to register subdomains, so `myblog.blogspot.com` is treated as its own domain. Pass `icann_only = TRUE` to restrict the lookup to the ICANN section of the list, in which case the domain is the "top domain under a registry suffix" (`blogspot.com`). 
